...
(function(){
  ...
  out$.auth = auth = function(form, cb){
    var baseUrl, email, password, confirmUrl, isBrowser, apiKey, ip, fullurl;
    baseUrl = form.baseUrl, email = form.email, password = form.password, confirmUrl = form.confirmUrl, isBrowser = form.isBrowser, apiKey = form.apiKey, ip = form.ip;
